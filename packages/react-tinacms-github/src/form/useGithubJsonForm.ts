...
import { useGithubFileForm, useGithubMultifileForm } from './useGithubFileForm'
...
export function useGithubMultifileJsonForm(
  jsonFiles: Array<GitFile>,
  formOptions?: Options
) {
  return useGithubMultifileForm(jsonFiles, {
    ...formOptions,
    serialize,
  })
}
